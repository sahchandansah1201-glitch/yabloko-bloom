...
const staticRoutes: RouteMeta[] = [
  ...
  {
    path: "/specialists",
    title: `Врачи клиники «Яблоко» — специалисты ${CITY_NOM}`,
  ...
  {
    path: "/services",
    title: `Услуги — ${CLINIC_NAME} ${CITY_NOM}`,
  ...
  {
    path: "/about",
    title: `О клинике «Яблоко» — ${CITY_NOM}`,
  ...
  {
    path: "/contacts",
    title: `Контакты — ${CLINIC_NAME} ${CITY_NOM}`,
    description: `Адрес, телефон и график работы ${CLINIC_NAME}. ул. 70-летия Октября, 1/2, ${CITY_NOM}. Запись по телефону +7 (918) 412-85-85.`,
  },
  {
    path: "/price",
    title: `Цены на услуги — ${CLINIC_NAME} ${CITY_NOM}`,
  ...
  {
    path: "/dokumenty",
    title: `Документы клиники — ${CLINIC_NAME}`,
    description: `Документы ${CLINIC_NAME}: оферта, политика обработки персональных данных, положение о платных услугах, информация для пациентов и формы информированного согласия.`,
  },
  {
    path: "/privacy",
