          ...
          <div className="container">
            <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
              ...
              >
                ...
                >
                  Клиника «Яблоко» — центр эстетической и интегративной медицины
                  в Краснодаре. Мы лечим причины, а не маскируем следствия:
                  точная диагностика, современные лазеры и индивидуальный протокол для каждого пациента.
                </motion.p>
