    ...
    subcategories: [
      {
        ...
        items: [
          ...
          { name: "Приём врача-дерматовенеролога первичный (Райкова С.А.)", price: "2 700 ₽", code: "B01.008.001", nomenclatureName: "Приём (осмотр, консультация) врача-дерматовенеролога первичный", bookable: true, doctorSlug: "raikova", serviceSlug: "consult-derm" },
          { name: "Приём врача-дерматовенеролога повторный (Райкова С.А.)", price: "2 700 ₽", code: "B01.008.002", nomenclatureName: "Приём (осмотр, консультация) врача-дерматовенеролога повторный", bookable: true, doctorSlug: "raikova", serviceSlug: "consult-derm" },
    ...
    subcategories: [
      {
        ...
        items: [
          ...
          { name: "Приём трихолога первичный (Райкова С.А.) + дерматоскопия", price: "3 000 ₽", code: "B01.008.001, А03.01.001", nomenclatureName: "Приём (осмотр, консультация) врача-дерматовенеролога первичный + Осмотр кожи под увеличением (дерматоскопия)", bookable: true, doctorSlug: "raikova", serviceSlug: "consult-triho" },
          { name: "Приём трихолога повторный (Райкова С.А.) + дерматоскопия", price: "3 000 ₽", code: "B01.008.002, А03.01.001", nomenclatureName: "Приём (осмотр, консультация) врача-дерматовенеролога повторный + Осмотр кожи под увеличением (дерматоскопия)", bookable: true, doctorSlug: "raikova", serviceSlug: "consult-triho" },
