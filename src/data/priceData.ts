    ...
    subcategories: [
      {
        ...
        items: [
          { name: "Пилинг Миндальный", price: "3 400 ₽", code: "А16.01.024", nomenclatureName: "Дерматологический пилинг", serviceSlug: "chemical-peeling" },
          { name: "Пилинг Салициловый", price: "3 400 ₽", code: "А16.01.024", nomenclatureName: "Дерматологический пилинг", serviceSlug: "chemical-peeling" },
          { name: "Пилинг Азелаиновый", price: "3 400 ₽", code: "А16.01.024", nomenclatureName: "Дерматологический пилинг", serviceSlug: "chemical-peeling" },
          { name: "Пилинг Джеснера", price: "4 350 ₽", code: "А16.01.024", nomenclatureName: "Дерматологический пилинг", serviceSlug: "chemical-peeling" },
          { name: "Пилинг Ретиноловый", price: "6 300 ₽", code: "А16.01.024", nomenclatureName: "Дерматологический пилинг", serviceSlug: "chemical-peeling" },
      ...
      },
      {
        title: "Чистка лица",
        items: [
          { name: "Чистка лица атравматичная, ультразвуковая", price: "3 200 ₽", code: "A14.01.005", nomenclatureName: "Очищение кожи лица и шеи", serviceSlug: "face-cleaning" },
          { name: "Чистка лица механическая", price: "3 700 ₽", code: "A14.01.005", nomenclatureName: "Очищение кожи лица и шеи", serviceSlug: "face-cleaning" },
          { name: "Комбинированная чистка лица", price: "4 500 ₽", code: "A14.01.005", nomenclatureName: "Очищение кожи лица и шеи", serviceSlug: "face-cleaning" },
          { name: "Комбинированная чистка лица (Павлюк М.О.)", price: "8 500 ₽", code: "A14.01.005", nomenclatureName: "Очищение кожи лица и шеи", serviceSlug: "face-cleaning", doctorSlug: "pavlyuk" },
      ...
      },
      {
        title: "Массаж лица",
        items: [
          { name: "Программа для подтяжки лица (60 мин)", price: "2 200 ₽", code: "A21.01.002", nomenclatureName: "Массаж лица медицинский (программа для подтяжки и молодости лица)" },
          { name: "Классический массаж лица (30 мин)", price: "1 350 ₽", code: "A21.01.002", nomenclatureName: "Массаж лица медицинский (классический)" },
          { name: "Криомассаж кожи", price: "1 200 ₽", code: "A24.01.005", nomenclatureName: "Криомассаж кожи" },
          { name: "Ультразвуковой массаж лица (15 мин)", price: "1 200 ₽", code: "A22.01.001", nomenclatureName: "Ультразвуковое лечение кожи (ультразвуковой массаж лица)" },
          { name: "Комплексная программа моделирования овала лица (классический)", price: "6 200 ₽", code: "A21.01.002, А17.01.008", nomenclatureName: "Массаж лица медицинский + Воздействие токами ультравысокой частоты на кожу (скрабирование, классический массаж, биомеханический массаж или RF-лифтинг, альгинатная маска)" },
          { name: "Комплексная программа моделирования овала лица (миофасциальный)", price: "7 200 ₽", code: "A21.01.002, А17.01.008", nomenclatureName: "Массаж лица медицинский + Воздействие токами ультравысокой частоты на кожу (миофасциальный массаж, биомеханический массаж или RF-лифтинг, альгинатная маска)" },
        ],
      },
      {
        title: "Лечебный массаж",
        items: [
          { name: "Общий массаж (до 120 кг), 60 мин", price: "2 500 ₽", code: "A21.01.001", nomenclatureName: "Общий массаж медицинский" },
          { name: "Общий массаж (более 120 кг), 60 мин", price: "2 800 ₽", code: "A21.01.001", nomenclatureName: "Общий массаж медицинский" },
          { name: "Массаж спины (до 120 кг)", price: "1 000 ₽", code: "А21.03.007", nomenclatureName: "Массаж спины медицинский" },
          { name: "Массаж спины (более 120 кг)", price: "1 250 ₽", code: "A21.01.003", nomenclatureName: "Массаж спины медицинский" },
          { name: "Массаж шеи + воротниковая область (15 мин)", price: "700 ₽", code: "A21.01.003.001", nomenclatureName: "Массаж шеи медицинский + массаж воротниковой области" },
          { name: "Массаж рук (обе)", price: "800 ₽", code: "A21.01.004", nomenclatureName: "Массаж верхней конечности медицинский" },
          { name: "Массаж руки (одна)", price: "400 ₽", code: "A21.01.004", nomenclatureName: "Массаж верхней конечности медицинский" },
          { name: "Детский массаж (1–3 года)", price: "900 ₽", code: "A21.01.001", nomenclatureName: "Общий массаж медицинский тела (детский)" },
          { name: "Детский массаж (4–5 лет)", price: "1 200 ₽", code: "А21.01.001", nomenclatureName: "Общий массаж медицинский тела (детский)" },
          { name: "Детский массаж (7–11 лет)", price: "1 500 ₽", code: "А21.01.001", nomenclatureName: "Общий массаж медицинский тела (детский)" },
          { name: "Детский массаж (12–14 лет)", price: "1 900 ₽", code: "А21.01.001", nomenclatureName: "Общий массаж медицинский тела (детский)" },
          { name: "Массаж спины детский (1–6 лет)", price: "700 ₽", code: "А21.03.007", nomenclatureName: "Массаж спины медицинский (детский)" },
          { name: "Массаж спины детский (7–11 лет)", price: "800 ₽", code: "А21.03.007", nomenclatureName: "Массаж спины медицинский (детский)" },
          { name: "Массаж спины детский (12–14 лет)", price: "900 ₽", code: "А21.03.007", nomenclatureName: "Массаж спины медицинский (детский)" },
          { name: "Антицеллюлитный/лимфодренажный массаж (60 мин)", price: "2 800 ₽", code: "A21.01.009", nomenclatureName: "Массаж нижней конечности медицинский (антицеллюлитный/лимфодренажный массаж, ягодицы + ноги)" },
          { name: "Комплексная антицеллюлитная программа", price: "8 450 ₽", code: "A21.01.009, А17.01.008", nomenclatureName: "Массаж нижней конечности медицинский + Воздействие токами ультравысокой частоты на кожу (лимфодренажный массаж, лазерно-вакуумный массаж или RF-лифтинг, антицеллюлитное обёртывание)" },
        ],
      },
    ],
  },
    ...
    subcategories: [
      {
        ...
        items: [
          { name: "Приём врача-диетолога первичный", price: "4 300 ₽", code: "B01.013.001", nomenclatureName: "Приём (осмотр, консультация) врача-диетолога первичный", bookable: true },
          { name: "Приём врача-диетолога повторный", price: "4 300 ₽", code: "B01.013.002", nomenclatureName: "Приём (осмотр, консультация) врача-диетолога повторный", bookable: true },
          { name: "Приём врача-диетолога + биоимпедансометрия (первичный)", price: "7 000 ₽", code: "B01.013.001, A05.30.014", nomenclatureName: "Приём (осмотр, консультация) врача-диетолога первичный + Определение процентного соотношения воды, мышечной и жировой ткани с помощью биоимпедансометра", bookable: true },
          { name: "Приём врача-диетолога + биоимпедансометрия (повторный)", price: "7 000 ₽", code: "B01.013.002, A05.30.014", nomenclatureName: "Приём (осмотр, консультация) врача-диетолога повторный + Определение процентного соотношения воды, мышечной и жировой ткани с помощью биоимпедансометра", bookable: true },
          { name: "Биоимпедансометрия", price: "2 700 ₽", code: "A05.30.014", nomenclatureName: "Определение процентного соотношения воды, мышечной и жировой ткани с помощью биоимпедансометра" },
          { name: "Биоимпедансометрия + приём врача-диетолога первичный", price: "5 000 ₽", code: "A05.30.014, B01.013.001", nomenclatureName: "Определение процентного соотношения воды, мышечной и жировой ткани с помощью биоимпедансометра + Приём (осмотр, консультация) врача-диетолога первичный (по результатам обследования)", bookable: true },
          { name: "Генетический тест «Диетология» + консультация", price: "22 900 ₽", code: "B03.019, A01.30.013", nomenclatureName: "Лабораторная генетика (генетический тест: панель «Диетология») + Сбор анамнеза и жалоб при генетическом консультировании" },
          { name: "Программа индивидуальной диетотерапии", price: "19 000 ₽", code: "B01.013.002", nomenclatureName: "Приём (осмотр, консультация) врача-диетолога повторный (программа индивидуальной диетотерапии)" },
          { name: "Программа похудения «Соло»", price: "28 000 ₽", code: "B01.013.001, B01.013.002", nomenclatureName: "Приём (осмотр, консультация) врача-диетолога первичный, повторный (программа похудения «Соло»)" },
          { name: "Программа похудения «Дуэт»", price: "40 000 ₽", code: "B01.013.001, B01.013.002", nomenclatureName: "Приём (осмотр, консультация) врача-диетолога первичный, повторный (программа похудения «Дуэт»)" },
          { name: "Программа похудения «Трио»", price: "60 000 ₽", code: "B01.013.001, B01.013.002, B03.019", nomenclatureName: "Приём (осмотр, консультация) врача-диетолога первичный, повторный + Лабораторная генетика (программа похудения «Трио»)" },
        ],
      },
    ],
  },
    ...
    subcategories: [
      {
        ...
        items: [
          { name: "Приём врача-терапевта первичный", price: "4 000 ₽", code: "В01.047.001", nomenclatureName: "Приём (осмотр, консультация) врача-терапевта первичный", bookable: true },
          { name: "Приём врача-терапевта повторный (в течение 1 мес.)", price: "4 000 ₽", code: "В01.047.002", nomenclatureName: "Приём (осмотр, консультация) врача-терапевта повторный", bookable: true },
        ],
      },
    ],
  },
    ...
    subcategories: [
      {
        ...
        items: [
          { name: "Приём врача-остеопата первичный + остеопатическая коррекция", price: "6 500 ₽", code: "B01.069.001, A21.30.008", nomenclatureName: "Приём (осмотр, консультация) врача-остеопата первичный + Остеопатическая коррекция соматических дисфункций", bookable: true },
          { name: "Приём врача-остеопата повторный + остеопатическая коррекция", price: "6 500 ₽", code: "B01.069.002, A21.30.008", nomenclatureName: "Приём (осмотр, консультация) врача-остеопата повторный + Остеопатическая коррекция соматических дисфункций", bookable: true },
          { name: "Приём врача-остеопата (дети до 12 лет) первичный", price: "6 500 ₽", code: "B01.069.001, A21.30.008", nomenclatureName: "Приём (осмотр, консультация) врача-остеопата первичный + Остеопатическая коррекция соматических дисфункций (дети до 12 лет)", bookable: true },
          { name: "Приём врача-остеопата (дети до 12 лет) повторный", price: "6 500 ₽", code: "B01.069.002, A21.30.008", nomenclatureName: "Приём (осмотр, консультация) врача-остеопата повторный + Остеопатическая коррекция соматических дисфункций (дети до 12 лет)", bookable: true },
        ],
      },
    ],
  },
    ...
    subcategories: [
      {
        ...
        items: [
          { name: "Приём врача-невролога первичный", price: "2 500 ₽", code: "B01.023.001", nomenclatureName: "Приём (осмотр, консультация) врача-невролога первичный", bookable: true },
          { name: "Приём врача-невролога повторный", price: "2 500 ₽", code: "B01.023.002", nomenclatureName: "Приём (осмотр, консультация) врача-невролога повторный", bookable: true },
        ],
      },
    ],
  },
    ...
    subcategories: [
      {
        ...
        items: [
          { name: "Базовый генетический тест «Косметология» (45 генов)", price: "15 800 ₽", code: "B03.019", nomenclatureName: "Лабораторная генетика" },
          { name: "Панель «Трихология» (24 гена)", price: "13 700 ₽", code: "B03.019", nomenclatureName: "Лабораторная генетика" },
          { name: "Панель «Диетология» (48 генов)", price: "17 900 ₽", code: "B03.019", nomenclatureName: "Лабораторная генетика" },
          { name: "Панель «Активное долголетие» (62 гена)", price: "17 900 ₽", code: "B03.019", nomenclatureName: "Лабораторная генетика" },
          { name: "Консультация врача по результатам тестирования", price: "5 000 ₽", code: "A01.30.013", nomenclatureName: "Сбор анамнеза и жалоб при генетическом консультировании (консультация врача по результатам генетического тестирования)", bookable: true },
        ],
      },
    ],
  },
