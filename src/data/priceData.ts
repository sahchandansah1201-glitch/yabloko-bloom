    ...
    subcategories: [
      {
        ...
        items: [
          { name: "Приём врача-дерматовенеролога (первичный), нутрициолога", price: "5 300 ₽", code: "B01.008.001", nomenclatureName: "Приём (осмотр, консультация) врача-дерматовенеролога (первичный), нутрициолога", bookable: true, doctorSlug: "medvedkova", serviceSlug: "nutritsiolog" },
        ],
      },
    ],
  },
    ...
    subcategories: [
      {
        ...
        items: [
          { name: "Приём врача-диетолога первичный", price: "4 300 ₽", code: "B01.013.001", nomenclatureName: "Приём (осмотр, консультация) врача-диетолога первичный", bookable: true, doctorSlug: "medvedkova", serviceSlug: "dietolog" },
          { name: "Приём врача-диетолога повторный", price: "4 300 ₽", code: "B01.013.002", nomenclatureName: "Приём (осмотр, консультация) врача-диетолога повторный", bookable: true, doctorSlug: "medvedkova", serviceSlug: "dietolog" },
          { name: "Приём врача-диетолога + биоимпедансометрия (первичный)", price: "7 000 ₽", code: "B01.013.001, A05.30.014", nomenclatureName: "Приём (осмотр, консультация) врача-диетолога первичный + Определение процентного соотношения воды, мышечной и жировой ткани с помощью биоимпедансометра", bookable: true, doctorSlug: "medvedkova", serviceSlug: "dietolog" },
          ...
          { name: "Программа похудения «Трио»", price: "60 000 ₽", code: "B01.013.001, B01.013.002, B03.019", nomenclatureName: "Приём (осмотр, консультация) врача-диетолога первичный, повторный + Лабораторная генетика (программа похудения «Трио»)", doctorSlug: "medvedkova", serviceSlug: "dietolog" },
        ],
      },
    ],
  },
    ...
    subcategories: [
      {
        ...
        items: [
          { name: "Приём врача-остеопата первичный + остеопатическая коррекция", price: "6 500 ₽", code: "B01.069.001, A21.30.008", nomenclatureName: "Приём (осмотр, консультация) врача-остеопата первичный + Остеопатическая коррекция соматических дисфункций", bookable: true, doctorSlug: "kovalev", serviceSlug: "osteopat" },
          { name: "Приём врача-остеопата повторный + остеопатическая коррекция", price: "6 500 ₽", code: "B01.069.002, A21.30.008", nomenclatureName: "Приём (осмотр, консультация) врача-остеопата повторный + Остеопатическая коррекция соматических дисфункций", bookable: true, doctorSlug: "kovalev", serviceSlug: "osteopat" },
          { name: "Приём врача-остеопата (дети до 12 лет) первичный", price: "6 500 ₽", code: "B01.069.001, A21.30.008", nomenclatureName: "Приём (осмотр, консультация) врача-остеопата первичный + Остеопатическая коррекция соматических дисфункций (дети до 12 лет)", bookable: true, doctorSlug: "kovalev", serviceSlug: "osteopat" },
          { name: "Приём врача-остеопата (дети до 12 лет) повторный", price: "6 500 ₽", code: "B01.069.002, A21.30.008", nomenclatureName: "Приём (осмотр, консультация) врача-остеопата повторный + Остеопатическая коррекция соматических дисфункций (дети до 12 лет)", bookable: true, doctorSlug: "kovalev", serviceSlug: "osteopat" },
        ],
      },
    ],
  },
